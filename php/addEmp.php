...
<table width="799" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
      ...
      <td width="98" align="center" valign="middle"><a href="second.php">浏览数据</a></td>
      <td width="100" align="center" valign="middle"><a href="#">添加用户</a></td>
...
<table width="799" border="0" cellpadding="0" cellspacing="0">
  ...
  <form name="intFrom" method="post" action="addAction.php">
		...
		<table width="100%" height="200"  border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
		  <td class="c_td">&nbsp;</td>
            <td align="right" valign="middle" class="c_td">书本封面</td>
            <td align="center" valign="middle" class="c_td">
